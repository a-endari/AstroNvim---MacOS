...
local os_config = "mac" -- Change to 'mac' or 'win' depending on your OS
...
local config = {
    cmd = {"java", "-Declipse.application=org.eclipse.jdt.ls.core.id1", "-Dosgi.bundles.defaultStartLevel=4",
           "-Declipse.product=org.eclipse.jdt.ls.core.product", "-Dlog.protocol=true", "-Dlog.level=ALL", "-Xmx4g",
           ...
           config_path .. os_config, "-data", workspace_path},
...
local bundles = {vim.fn.glob(mason_path ..
